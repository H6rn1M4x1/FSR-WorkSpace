...
const oldLabel = '{formTipoMercado === "Cripto" ? "(Sin comisiones)" : "(Incluye comisiones IOL)"}';
const newLabel = '{formTipoMercado === "Cripto" ? "(Incluye 0.1% Binance)" : "(Incluye comisiones IOL)"}';
