    ...
    if (mesh.current) {
      ...
      if (material && material.uniforms && material.uniforms.time) {
        ...
        if (!prevColor.current.every((v, i) => v === waveColor[i])) {
          material.uniforms.waveColor.value.set(...waveColor);
          prevColor.current = [...waveColor];
        }
        if (!prevBgColor.current.every((v, i) => v === backgroundColor[i])) {
          material.uniforms.backgroundColor.value.set(...backgroundColor);
        ...
        if (enableMouseInteraction) {
          material.uniforms.mousePos.value.copy(mouseRef.current);
        }
      }
    }
  });
