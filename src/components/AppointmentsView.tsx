                                    ...
                                    <div className="flex items-center gap-2 mt-1.5 min-w-0">
                                      ...
                                      >
                                        <input
                                          ...
                                          checked={tc.estatus}
                                          onChange={async (e) => {
                                            console.log("[DEBUG] Checkbox Listo (tarjeta) clickeado, tc.id:", tc.id, "activeUserId:", activeUserId);
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-center md:sticky md:left-0 z-20 bg-white dark:bg-zinc-950 group-hover:bg-slate-50 dark:group-hover:bg-zinc-900 transition-colors min-w-[70px] w-[70px] max-w-[70px]">
                            <input
                              ...
                              checked={tc.estatus}
                              onChange={async (e) => {
                                console.log("[DEBUG] Checkbox Listo clickeado, tc.id:", tc.id, "activeUserId:", activeUserId);
                                const newChecked = e.target.checked;
                                const updatedItem = { ...tc, estatus: newChecked, updatedAt: Date.now() };
                                setTurnosCompromisos((prev) => {
                                  const updated = prev.map((item) =>
