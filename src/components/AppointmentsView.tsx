                                    ...
                                    <div className="flex items-center gap-2 mt-1.5 min-w-0">
                                      ...
                                      >
                                        ...
                                        {(tc as any).__sharedByEmail && (
                                          <span
                                            title={`Compartido por ${(tc as any).__sharedByEmail}`}
                                            className="shrink-0 self-center inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-primary/15 text-primary text-[9px] font-extrabold"
                                          >
