...
export default function AcademicView({
  ...
  // NOTE: subjects, tasks, notes, materias_info, horarios and examenes used to have
  // their own duplicate real-time Firestore subscription here. They already arrive as
  // live props from App.tsx's single central subscription, so it was removed.
                                      ...
                                      <div className="flex items-center gap-2.5 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                          <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            <SharedBadge
                                              item={item}
                                              isSharedOut={isSharedOut(item.type === "examen" ? "examenes" : "tasks", item.id)}
                                              sharedOutWith={sharedOutWith(item.type === "examen" ? "examenes" : "tasks", item.id)}
                                            />
                                            {item.subjectName && (
